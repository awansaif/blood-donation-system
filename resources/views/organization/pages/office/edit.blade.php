            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Update Office</h3>
                        </div>
                    </div>
                </div>
                <form action="{{ Route('org.office.update', $office->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="address" id="input-username" class="form-control"
                                            placeholder="Sub Office Address" value="{{ $office->address }}"
                                            name="address">
                                    </div>
                                    @error('address')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-first-name" class="form-control"
                                            placeholder="Mobile phone" value="{{ $office->mobile }}" name="mobile">
                                    </div>
                                    @error('mobile')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-first-name">Office
                                            Head:</label>
                                        <input type="text" id="input-first-name" class="form-control"
                                            placeholder="Office Heade manager name" value="{{ $office->head }}"
                                            name="head">
                                    </div>
                                    @error('head')
                                    <p class="text-danger">{{ $message }}</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-first-name" class="form-control"
                                            placeholder="Office City" value="{{ $office->city }}" name="city">
                                    </div>
                                    @error('city')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
